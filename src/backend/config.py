...
ENABLE_RERANK = os.getenv("ENABLE_RERANK", "false").strip().lower() in {"1", "true", "yes", "on"}
...
RAG_INDEX_VERSION = os.getenv("RAG_INDEX_VERSION", DEFAULT_RAG_INDEX_VERSION).strip() or DEFAULT_RAG_INDEX_VERSION

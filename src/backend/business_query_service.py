...
from business_query_aggregation import (
    detect_aggregate_metric as _detect_aggregate_metric_impl,
...
def _detect_aggregate_metric(text: str, fields: List[str], *, module: str, year: int | None) -> str | None:
    return _detect_aggregate_metric_impl(
        text,
        fields,
        module=module,
        year=year,
        closure_field_hints=CLOSURE_FIELD_HINTS,
        studies_aggregate_keywords=STUDIES_AGGREGATE_KEYWORDS,
        production_aggregate_keywords=PRODUCCION_AGGREGATE_KEYWORDS,
        production_month_fields=PRODUCTION_MONTH_FIELDS,
        schema_field_synonyms=_schema_field_synonyms,
        contains_cierre_hint=_contains_cierre_hint,
    )


def _is_count_request(text: str) -> bool:
    return _is_count_request_impl(text)
...
def _detect_count_metric(text: str, module: str) -> str:
    return _detect_count_metric_impl(text, module, contains_cierre_hint=_contains_cierre_hint)
